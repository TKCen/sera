/**
 * OMX Bridge — invokes the `codex` CLI for each task received from sera.
 *
...
class OmxBridge extends BridgeBase {
  constructor() {
    super({
      toolName: 'omx',
      displayName: 'OMX Bridge (host)',
    });
  }
