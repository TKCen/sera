...
use sera_types::{EmbeddingService, memory::SegmentKind};

use crate::{
    EvictionPolicy, MemoryId, PutRequest, ScoredEntry, Scope, SemanticEntry, SemanticError,
...
mod tests {
    ...
    use crate::{Damping, Scope, ScopeHierarchy};
