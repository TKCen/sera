...
describe('VectorService Hybrid Search Logic', () => {
  ...
  it('should re-rank with MMR correctly', () => {
    ...
    const candidates = [
      { id: '1', score: 1.0, vector: v1, payload: {} as unknown as VectorPayload, namespace: 'global' },
      { id: '2', score: 0.9, vector: v2, payload: {} as unknown as VectorPayload, namespace: 'global' },
      { id: '3', score: 0.8, vector: v3, payload: {} as unknown as VectorPayload, namespace: 'global' },
    ] as SearchResult[];
