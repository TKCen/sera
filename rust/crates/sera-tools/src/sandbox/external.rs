//! External sandbox provider stub.
...
/// Stub external sandbox provider — all methods return `NotImplemented`.
pub struct ExternalSandboxProvider;

#[async_trait]
impl SandboxProvider for ExternalSandboxProvider {
    fn name(&self) -> &str {
        "external"
    }
